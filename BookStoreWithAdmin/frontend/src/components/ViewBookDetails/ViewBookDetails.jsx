...
const ViewBookDetails = () => {
    ...
    const navigate =  useNavigate();
      ...
      if(!Data) return <p className='text-white'>No Book Found</p>
      const headers = {
    ...
    {Data && ( <div className='px-4 md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-8'>
      <div className='w-full lg:w-3/6 '>
        ...
        {isLoggedIn === true && role === 'user' &&  (
          ...
          <button className='text-white rounded lg:rounded-full text-3xl p-3 mt-8 md:mt-0 lg:mt-8 bg-blue-500 flex items-center justify-center'onClick={handleCart}>
      ...
      <div className='p-4 w-3/6 text-white'>
        ...
        <p className='mt-4 text-xl text-zinc-500'>{Data.desc}</p>
